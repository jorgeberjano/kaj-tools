...
public class JsonGeneratorPanel extends BasePanel implements InfoReportable {
    ...
    public JsonGeneratorPanel(UiComponentCreator componentFactory) {
    ...
    private Object instantiateObjet(String nombreClase) {
        ...
        if (generatedObject == null) {
            enqueueMessage(InfoReportable.buildErrorMessage("No se ha podido crear la instancia el objeto"));
        } else {
    ...
    private String generateJson(Object generatedObject) {
        ...
        String json = null;
        try {
            json = creator.getJsonFromObject(generatedObject);
        } catch (JsonProcessingException ex) {
            enqueueException(ex);
        }

        if (StringUtils.isBlank(json)) {
            enqueueMessage(InfoReportable.buildErrorMessage("No se ha podido generar el JSON"));
        } else {
    ...
    private String generateSchema(Object generatedObject) {
        ...
        if (StringUtils.isBlank(schema)) {
            enqueueMessage(InfoReportable.buildErrorMessage("No se ha podido generar el esquema AVRO"));
        } else {
    ...
    private Object instantiateObjetFromJson(String nombreClase, String json) {
        ...
        if (generatedObject != null) {
            ...
            enqueueMessage(InfoReportable.buildErrorMessage("No se ha podido crear la instancia el Objeto desde el JSON"));
        }
        enqueueMessages(creator.getErrors());
        return generatedObject;
    }
    ...
    private void $$$setupUI$$$() {
        ...
        contentPane.add(topPanel, new GridConstraints(0, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        topPanel.add(label2, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        classComboBox = new JComboBox();
        classComboBox.setEditable(true);
        topPanel.add(classComboBox, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JPanel panel1 = new JPanel();
        panel1.setLayout(new GridLayoutManager(1, 4, new Insets(0, 0, 0, 0), -1, -1));
        contentPane.add(panel1, new GridConstraints(1, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel1.add(generateJsonButton, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        panel1.add(checkJsonButton, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JPanel panel2 = new JPanel();
        panel2.setLayout(new BorderLayout(0, 0));
        contentPane.add(panel2, new GridConstraints(3, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel4.add(cleanButton, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel4.add(spacer3, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_NONE, 1, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(-1, 30), null, 0, false));
    }
