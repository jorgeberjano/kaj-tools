...
public class KafkaConsumerPanel extends KafkaBasePanel {
    ...
    private TablaGenerica recordTable;
    ...
    private MessageFilter consumeFilter;
    private MessageFilter showFilter;
    private int maxRecords = 50;
    private int recordConsumedCount = 0;
    @Getter
    private InfoTextPane infoTextPane;

    private JPopupMenu recordTablePopupMenu;
    ...
    public KafkaConsumerPanel(List<IMessageClient> clientList,
        ...
        super(clientList, schemaRegistryService, kafkaInvestigator, componentFactory);
        ...
        recordTablePopupMenu = new JPopupMenu();
        JMenuItem compareActionListener = new JMenuItem("Aplicar filtro sobre los mensajes consumidos");
        compareActionListener.addActionListener(e -> applyFilterToConsumedMessages());
        recordTablePopupMenu.add(compareActionListener);

        JMenuItem deleteActionListener = new JMenuItem("Copiar tabla al portapapeles");
        deleteActionListener.addActionListener(e -> copyRecordTableToClipboard());
        recordTablePopupMenu.add(deleteActionListener);
        recordTable.setComponentPopupMenu(recordTablePopupMenu);
    ...
    private void applyFilterToConsumedMessages() {
        try {
            showFilter = retrieveActualFilter();
        } catch (KajException ex) {
            printMessage(InfoReportable.buildErrorMessage("El filtro tiene errores"));
            printException(ex);
            return;
        }

        printMessage(InfoReportable.buildActionMessage("Aplicando el filtro a los mensajes consumidos..."));
        this.<Void>executeAsyncTask(this::checkFilterTableMessages);
    }
    ...
    private void checkFilter(RecordItem recordItem, MessageFilter filter) {
        try {
            recordItem.setMatchFilter(filter.satisfyCondition(recordItem));
        } catch (KajException e) {
            recordItem.getErrors().add("No se pudo aplicar el filtro: " + e.getMessage());
        }
    }

    private void copyRecordTableToClipboard() {
    }
    ...
    private void updateConsumers() {
        ...
        clientList.stream()
                .filter(c -> StringUtils.isBlank(domain) || domain.equals(c.getDomain()) || c instanceof GenericClient)
    ...
    private void consume() {
        ...
        try {
            consumeFilter = retrieveActualFilter();
        } catch (KajException ex) {
            printMessage(InfoReportable.buildErrorMessage("El filtro tiene errores"));
            printException(ex);
            return;
    ...
    private MessageFilter retrieveActualFilter() throws KajException {
    ...
    private void showMoreRecords(List<RecordItem> recordItems) {
        int previousRecordCount = recordItemsList.size();
        ...
        for (RecordItem rec : recordItems) {
            ...
            recordConsumedCount++;
            if (rec.isMatchFilter()) {
                recordItemsList.add(rec);
            }
            if (!CollectionUtils.isEmpty(rec.getErrors())) {
                printMessage(InfoReportable.buildErrorMessage("El mensaje con partición "
                        + rec.getPartition() + " y offset " + rec.getOffset() + " produjo errores"));
                printLink(InfoDocument.simpleDocument("errores", Type.INFO,
                        StringUtils.join(rec.getErrors(), "\n")));
            }
        }
        if (recordItemsList.size() > previousRecordCount) {
            recordTableModel.actualizar();
        }
        ...
        try {
            client.consumeLastRecords(environment, topic, dateTimeToRewind, abortTasks, new ConsumerFeedback() {
                ...
                public void consumedRecords(List<RecordItem> records) {
                    ...
                    records.forEach(r -> checkFilter(r, consumeFilter));
    ...
    private void $$$setupUI$$$() {
        ...
        contentPane.add(panel1, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        comboTopic = new JComboBox();
        comboTopic.setEditable(true);
        final DefaultComboBoxModel defaultComboBoxModel1 = new DefaultComboBoxModel();
        comboTopic.setModel(defaultComboBoxModel1);
        panel1.add(comboTopic, new GridConstraints(3, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label1 = new JLabel();
        this.$$$loadLabelText$$$(label1, this.$$$getMessageFromBundle$$$("messages", "label.topic"));
        panel1.add(label1, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(137, 16), null, 0, false));
        ...
        panel1.add(comboEnvironment, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        comboConsumer = new JComboBox();
        comboConsumer.setEditable(false);
        final DefaultComboBoxModel defaultComboBoxModel3 = new DefaultComboBoxModel();
        comboConsumer.setModel(defaultComboBoxModel3);
        panel1.add(comboConsumer, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel1.add(comboDomain, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel1.add(buttonFindTopic, new GridConstraints(3, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, new Dimension(24, 24), new Dimension(24, 24), new Dimension(24, 24), 0, false));
        ...
        panel1.add(buttonCheckEnvironment, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, new Dimension(24, 24), new Dimension(24, 24), new Dimension(24, 24), 0, false));
        final JPanel panel2 = new JPanel();
        panel2.setLayout(new BorderLayout(0, 0));
        contentPane.add(panel2, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        contentPane.add(splitPane1, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, new Dimension(200, 245), null, 0, false));
        ...
        panel4.add(cleanButton, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel4.add(copyButton, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel4.add(spacer2, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_NONE, 1, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(-1, 30), null, 0, false));
        final JPanel panel5 = new JPanel();
        panel5.setLayout(new GridLayoutManager(1, 10, new Insets(0, 0, 0, 0), -1, -1));
        contentPane.add(panel5, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, 1, null, null, null, 0, false));
        consumeButtom = new JButton();
        this.$$$loadButtonText$$$(consumeButtom, this.$$$getMessageFromBundle$$$("messages", "button.consume"));
        panel5.add(consumeButtom, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        panel5.add(fieldMaxRecords, new GridConstraints(0, 6, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(40, -1), null, 0, false));
        ...
        panel5.add(label6, new GridConstraints(0, 5, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final Spacer spacer3 = new Spacer();
        panel5.add(spacer3, new GridConstraints(0, 9, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        ...
        panel5.add(comboFilterType, new GridConstraints(0, 7, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(80, -1), null, 0, false));
        textFieldFilter = new JTextField();
        panel5.add(textFieldFilter, new GridConstraints(0, 8, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        ...
        panel5.add(buttonStop, new GridConstraints(0, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        labelCounter = new JLabel();
        labelCounter.setHorizontalAlignment(0);
        labelCounter.setText("0");
        panel5.add(labelCounter, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, new Dimension(80, -1), new Dimension(80, -1), null, 0, false));
        comboRewind = new JComboBox();
        panel5.add(comboRewind, new GridConstraints(0, 4, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
    ...
    private void createUIComponents() {
        ...
        recordTable.setColoreador(new ColoreadorFila<RecordItem>() {
            ...
            public Color determinarColorTexto(RecordItem entidad) {
                if (!CollectionUtils.isEmpty(entidad.getErrors())) {
                    return new Color(0xF96966);
                } else {
                    return null;
                }
            }
